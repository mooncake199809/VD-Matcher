...
_CN.SEED = CN()
_CN.SEED.WS = 5                            # 长宽5等分
_CN.SEED.NUM1 = 0.2                       # 每个窗口中取出50个点
_CN.SEED.NUM2 = 0.2                        # 每个窗口中取出50个点
_CN.SEED.MASK_EDGE = 2
_CN.SEED.GLOBAL_SEED_TYPE = "sobel"         # features / canny / sobel
_CN.SEED.SEED_TYPE = "pca"                # sum / pca
_CN.SEED.OBTAIN_SEED = "topk"             # bbox / topk / superpoint 
_CN.SEED.TOPK_NUM = 2048
_CN.SEED.SAVE_RES = False
...
_CN.COARSE.NHEAD = 8
_CN.COARSE.LAYER_NAMES = ['self', 'cross'] * 1
_CN.COARSE.ISALL = [True, True] * 1
_CN.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.COARSE.TEMP_BUG_FIX = True
_CN.COARSE.SEED_NUM = 3600
_CN.COARSE.SEED_NUM_MAX = 10240
_CN.COARSE.REPEAT_TIME = 2
_CN.COARSE.FFN_RATIO = 3


# 2+. LoFTR-coarse module config
_CN.POINT = CN()
_CN.POINT.D_MODEL = 256
_CN.POINT.D_FFN = 256
_CN.POINT.NHEAD = 8
_CN.POINT.LAYER_NAMES = ['self', 'cross'] * 1
_CN.POINT.ISALL = [False, False] * 1
_CN.POINT.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.POINT.TEMP_BUG_FIX = True
_CN.POINT.REPEAT_FIRST = 3
_CN.POINT.REPEAT_SECOND = 3
_CN.POINT.USE_BASE = True
_CN.POINT.FFN_RATIO = 3


# 2+. LoFTR-coarse module config
_CN.POINT_LAST = CN()
_CN.POINT_LAST.D_MODEL = 256
_CN.POINT_LAST.D_FFN = 256
_CN.POINT_LAST.NHEAD = 8
_CN.POINT_LAST.LAYER_NAMES = ['self', 'cross'] * 1
_CN.POINT_LAST.ISALL = [False, False] * 1
_CN.POINT_LAST.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.POINT_LAST.TEMP_BUG_FIX = True
_CN.POINT_LAST.REPEAT_LAST = 2
_CN.POINT_LAST.FFN_RATIO = 3
...
_CN.IMG.D_FFN = 256
_CN.IMG.NHEAD = 8
_CN.IMG.LAYER_NAMES = ['self', 'cross'] * 1
_CN.IMG.ISALL = [False, False] * 1
_CN.IMG.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.IMG.TEMP_BUG_FIX = True


# 3. Coarse-Matching config
_CN.MATCH_COARSE = CN()
_CN.MATCH_COARSE.THR = 0.6
...
_CN.FINE.ISALL = [True, True] * 1
_CN.FINE.ATTENTION = 'linear'
_CN.FINE.REPEAT_TIME = 1
_CN.FINE.USE_BASE = True
_CN.FINE.FFN_RATIO = 3
...
# _CN.LOSS.SPARSE_SPVS = False
# -- - -- # focal loss (coarse)
_CN.LOSS.FOCAL_ALPHA = 0.25
_CN.LOSS.FOCAL_GAMMA = 2.0
_CN.LOSS.POS_WEIGHT = 1.0
_CN.LOSS.NEG_WEIGHT = 1.0
# _CN.LOSS.DUAL_SOFTMAX = False  # whether coarse-level use dual-softmax or not.
# use `_CN.MATCH_COARSE.MATCH_TYPE`
