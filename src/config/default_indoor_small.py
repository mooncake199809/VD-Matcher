...
# 种子配置文件
_CN.LOFTR.SEED = CN()
_CN.LOFTR.SEED.WS = 5                            # 长宽5等分
_CN.LOFTR.SEED.NUM1 = 0.2                       # 每个窗口中取出50个点
_CN.LOFTR.SEED.NUM2 = 0.2                        # 每个窗口中取出50个点
_CN.LOFTR.SEED.MASK_EDGE = 2
_CN.LOFTR.SEED.GLOBAL_SEED_TYPE = "sobel"         # features / canny / sobel
_CN.LOFTR.SEED.SEED_TYPE = "pca"                # sum / pca
_CN.LOFTR.SEED.OBTAIN_SEED = "topk"             # bbox / topk / superpoint 
_CN.LOFTR.SEED.TOPK_NUM = 2048
_CN.LOFTR.SEED.SAVE_RES = False
...
_CN.LOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 1
_CN.LOFTR.COARSE.ISALL = [True, True] * 1
_CN.LOFTR.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.COARSE.TEMP_BUG_FIX = True
_CN.LOFTR.COARSE.SEED_NUM = 3600
_CN.LOFTR.COARSE.SEED_NUM_MAX = 4800
_CN.LOFTR.COARSE.REPEAT_TIME = 2
_CN.LOFTR.COARSE.FFN_RATIO = 2


# 2+. LoFTR-coarse module config
_CN.LOFTR.POINT = CN()
_CN.LOFTR.POINT.D_MODEL = 256
_CN.LOFTR.POINT.D_FFN = 256
_CN.LOFTR.POINT.NHEAD = 8
_CN.LOFTR.POINT.LAYER_NAMES = ['self', 'cross'] * 1
_CN.LOFTR.POINT.ISALL = [False, False] * 1
_CN.LOFTR.POINT.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.POINT.TEMP_BUG_FIX = True
_CN.LOFTR.POINT.REPEAT_FIRST = 3
_CN.LOFTR.POINT.REPEAT_SECOND = 3
_CN.LOFTR.POINT.USE_BASE = False
_CN.LOFTR.POINT.FFN_RATIO = 2


# 2+. LoFTR-coarse module config
_CN.LOFTR.POINT_LAST = CN()
_CN.LOFTR.POINT_LAST.D_MODEL = 256
_CN.LOFTR.POINT_LAST.D_FFN = 256
_CN.LOFTR.POINT_LAST.NHEAD = 8
_CN.LOFTR.POINT_LAST.LAYER_NAMES = ['self', 'cross'] * 1
_CN.LOFTR.POINT_LAST.ISALL = [False, False] * 1
_CN.LOFTR.POINT_LAST.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.POINT_LAST.TEMP_BUG_FIX = True
_CN.LOFTR.POINT_LAST.REPEAT_LAST = 2
_CN.LOFTR.POINT_LAST.FFN_RATIO = 2


_CN.LOFTR.IMG = CN()
_CN.LOFTR.IMG.D_MODEL = 256
_CN.LOFTR.IMG.D_FFN = 256
_CN.LOFTR.IMG.NHEAD = 8
_CN.LOFTR.IMG.LAYER_NAMES = ['self', 'cross'] * 1
_CN.LOFTR.IMG.ISALL = [False, False] * 1
_CN.LOFTR.IMG.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.IMG.TEMP_BUG_FIX = True
...
_CN.LOFTR.FINE.ISALL = [False, False] * 1
_CN.LOFTR.FINE.ATTENTION = 'linear'
_CN.LOFTR.FINE.REPEAT_TIME = 1
_CN.LOFTR.FINE.USE_BASE = False
_CN.LOFTR.FINE.FFN_RATIO = 2
