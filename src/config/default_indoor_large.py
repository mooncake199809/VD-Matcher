...
_CN.LOFTR.POINT.USE_BASE = True
_CN.LOFTR.POINT.FFN_RATIO = 3
...
_CN.LOFTR.POINT_LAST.FFN_RATIO = 3
...
_CN.LOFTR.FINE.USE_BASE = True
_CN.LOFTR.FINE.FFN_RATIO = 3
