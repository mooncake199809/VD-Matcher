...
TRAIN_BASE_PATH = "data/scannet/index"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "ScanNet"
cfg.DATASET.TRAIN_DATA_ROOT = "/mnt/lustre/xietao/scannet/mnt/share/sda-8T/xt/scannet/"
cfg.DATASET.TRAIN_NPZ_ROOT = "/mnt/lustre/xietao/scannet/train/"
cfg.DATASET.TRAIN_LIST_PATH = "/mnt/lustre/xietao/scannet/scannet_all.txt"
cfg.DATASET.TRAIN_INTRINSIC_PATH = "/mnt/lustre/xietao/scannet/intrinsics.npz"


TEST_BASE_PATH = "assets/scannet_test_1500"
cfg.DATASET.TEST_DATA_SOURCE = "ScanNet"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "/mnt/lustre/xietao/scannet_test/scannet_test_1500/"
