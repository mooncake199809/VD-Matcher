...
def parse_args():
    ...
    parser.add_argument(
        '--config_type', type=str, default="default_outdoor_small")
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    assert config_type in ["default_outdoor_small", "default_outdoor_large", \
                            "default_indoor_small", "default_indoor_large"], print("Config Type Error")
    if config_type == "default_outdoor_small":
        from src.config.default_outdoor_small import get_cfg_defaults
    if config_type == "default_outdoor_large":
        from src.config.default_outdoor_large import get_cfg_defaults
    if config_type == "default_indoor_small":
        from src.config.default_indoor_small import get_cfg_defaults
    if config_type == "default_indoor_large":
        from src.config.default_indoor_large import get_cfg_defaults    
